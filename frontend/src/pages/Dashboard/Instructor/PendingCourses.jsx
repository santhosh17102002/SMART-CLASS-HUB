...
const ApprovedCourse = () => {
    ...
    useEffect(() => {
        axiosSecure.get(`/pending-classes/${currentUser?.email}`)
        ...
        <div>
            <div className="my-9">
                ...
                <div className="text-center">
                    ...
                    <Fade duration={100} className='text-[12px]  text-center' cascade>Here you can see how many classes added by you which are approved</Fade>
                </div>
